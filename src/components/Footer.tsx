...
const Footer = () => {
  ...
  return (
    <footer
      id="footer"
      className={`bg-muted/50 border-t transition-opacity duration-1000 ${
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-muted-foreground">
              Modern AI-powered vision solutions
            </p>
          </div>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex space-x-4 justify-center md:justify-end">
              ...
              <a
                href="https://x.com/AkarshanGhosh28?t=Sx0VhD738lSehRc4EWBINg&s=09"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
                aria-label="Twitter"
              ...
              <a
                href="https://akarshanghosh.github.io/Akarshan_portfolio/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
                aria-label="Website"
